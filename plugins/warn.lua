...
----------------------------------
  ...
  return send_msg(receiver, '<b>➡ شما نمیتوانید به مدیر گروه اخطار بدهید!</b>', ok_cb, false) end
--endif--
  if is_admin2(msg.id) then return send_msg(receiver, '<b>➡ شما نمیتوانید به ادمین ربات اخطار بدهید!</b>', ok_cb, false) end
--endif--
  if value then
   if value == '1' then
