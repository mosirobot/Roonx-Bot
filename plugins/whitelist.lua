...
local function get_message_callback (extra , success, result)
	...
	if is_whitelisted then
		...
		send_large_msg(receiver, "<b>➡ کاربر/ربات</b> ["..user_id.."] <b>از لیست سفید پاک شد</b>")
	else
		redis:sadd(hash, user_id)
		send_large_msg(receiver, "<b>➡ کاربر/ربات</b> ["..user_id.."] <b>به لیست سفید اضافه شد</b>")
	end
...
if matches[1] == "whitelist" and is_admin1(msg) then
    ...
    elseif string.match(matches[2], '^%d+$') then
		...
		if is_whitelisted then
			redis:srem(hash, user_id)
			return "<b>➡ کاربر/ربات</b> ["..user_id.."] <b>از لیست سفید پاک شد</b>"
		else
			redis:sadd(hash, user_id)
			return "<b>➡ کاربر/ربات</b>["..user_id.."] <b>به لیست سفید اضافه شد</b>"
		end
