...
local service = msg.service
	if to == 'user' and msg.fwd_from then
		...
		text = "<b>➡ مشخصات پیام فوروارد شده:</b>:\n\n<b>آیدی</b>: "..from_id.."\n<b>نام</b>: "..from_first_name.."\n<b>نام کاربری</b>: "..from_last_name.."\n<b>یوزرنیم</b>: "..from_username
...
local function chat_list(msg)
    ...
    if not data[tostring(groups)] then
        return '<b>➡ هیچ گروهی در حال حاظر نیست</b>'
    end
    local message = '<b>➡ لیست گروه ها</b>:\n<b>➡ استفاده از</b> #join (ID) <b>برای عضویت</b>\n\n'
...
if to == 'user' or service or is_admin1(msg) and to == "chat" or to == "channel" then
	...
	if matches[1] == 'help' and msg.to.type == 'user' or matches[1] == 'pmhelp' and is_admin1(msg) and msg.to.type ~= 'user' then
		...
		text = "<b>➡ سلام به ربات آنتی اسپم رونکس تیم خوش اومدی\nاین ربات برای امنیت بیشتر گروه ها ساخته شده جهت خرید اشتراک به @alireza_x5_bot مراجعه کنید.</b>"
     	return text
    end
