...
local function chat_stats(receiver, chat_id)
  ...
  local text = '<b>➡ کاربران در این چت</b> \n'
...
local function run(msg, matches)
  if matches[1]:lower() == 'roonx' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "roonx" then -- Put everything you like :)
